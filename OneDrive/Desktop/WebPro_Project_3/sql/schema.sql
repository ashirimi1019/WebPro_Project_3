...
-- ============================================
-- This script creates all necessary tables for the adaptive puzzle game
-- Execute this in command-line MySQL (NO GUI TOOLS)

-- Drop existing database if it exists (CAUTION: This deletes all data)
DROP DATABASE IF EXISTS christmas_puzzle;

-- Create the database
CREATE DATABASE christmas_puzzle CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
